[![Build Status](https://travis-ci.org/nomadreservations/ngx-cacheable.svg?branch=master)](https://travis-ci.org/nomadreservations/ngx-cacheable)
# ngx-cacheable

This is an ng-packager fork of the project at [https://github.com/angelnikolov/ngx-cacheable](https://github.com/angelnikolov/ngx-cacheable)

This was created so proper umd sources are generated to support ivy and bazel
...
* **Paul Ryan** - Use ng-packagr for UMD Bundling
